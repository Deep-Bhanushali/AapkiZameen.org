        ...
        <div className="container">
          ...
          <div className="properties-grid">
            ...
            <a href="/featured?category=Residential Plot" className="property-card-link">
              <div className="property-card">
                <div className="property-image">
                  <img src="https://images.unsplash.com/photo-1555636222-cae831e670b3?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cmVzaWRlbnRpYWx8ZW58MHx8MHx8fDA%3D" alt="Residential Plots" loading="lazy" />
                </div>
                <div className="property-content">
            ...
            <a href="/featured?category=Commercial" className="property-card-link">
              <div className="property-card">
                <div className="property-image">
                  <img src="https://images.unsplash.com/opengraph/1x1.png?mark=https:%2F%2Fimages.unsplash.com%2Fopengraph%2Flogo.png&mark-w=64&mark-align=top%2Cleft&mark-pad=50&h=630&w=1200&blend=https:%2F%2Fimages.unsplash.com%2Fphoto-1497366754035-f200968a6e72%3Fcrop%3Dfaces%252Cedges%26h%3D630%26w%3D1200%26blend%3D000000%26blend-mode%3Dnormal%26blend-alpha%3D10%26mark-w%3D750%26mark-align%3Dmiddle%252Ccenter%26mark%3Dhttps%253A%252F%252Fimages.unsplash.com%252Fopengraph%252Fsearch-input.png%253Fw%253D750%2526h%253D84%2526txt%253Dcommercial%252Bproperty%2526txt-pad%253D80%2526txt-align%253Dmiddle%25252Cleft%2526txt-color%253D%252523000000%2526txt-size%253D40%2526txt-width%253D660%2526txt-clip%253Dellipsis%2526auto%253Dformat%2526fit%253Dcrop%2526q%253D60%26auto%3Dformat%26fit%3Dcrop%26q%3D60%26ixid%3DM3wxMjA3fDB8MXxzZWFyY2h8Mnx8Y29tbWVyY2lhbCUyMHByb3BlcnR5fGVufDB8fHx8MTc1Njc2MTg2MHww%26ixlib%3Drb-4.1.0&blend-w=1&auto=format&fit=crop&q=60" alt="Commercial Land" loading="lazy" />
                </div>
                <div className="property-content">
            ...
            <a href="/featured?category=Farmhouse" className="property-card-link">
              <div className="property-card">
                <div className="property-image">
                  <img src="https://media.istockphoto.com/id/182747133/photo/traditional-farmhouse.webp?b=1&s=170667a&w=0&k=20&c=l3jAeiE8x_32dQ2inWBhKrF3iF_tDkXhz004f2GZMJo=" alt="Farmhouse Plots" loading="lazy" />
                </div>
                <div className="property-content">
            ...
            <a href="/featured?category=Industrial" className="property-card-link">
              <div className="property-card">
                <div className="property-image">
                  <img src="https://media.istockphoto.com/id/1796681465/photo/industrial-area-and-buildings-aerial-view.webp?b=1&s=170667a&w=0&k=20&c=gNRDqR5X7FAA2rg1kCS64ArLhU5BbiTMaliT-tE1IaM=" alt="Industrial Land" loading="lazy" />
                </div>
                <div className="property-content">
